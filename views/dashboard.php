<?php
    ...
    // $all_users holds all the users from the database
    // print_r($all_users);
?>
                    ...
                    ?>
                            <tr>
                                <td>
                                    ...
                                    <?php                              //shorthand for <?php echo ~>,  class dblock for  mxauto for centered, dashboard for itself
                                        } else {
                                    ?>
